...
#                    print("command: ", command)
                ...
                self.line1_1.set_xdata([xpos, xpos + 4*a[0]])
                self.line1_1.set_ydata([ypos, ypos + 4*a[1]])
                self.line1_2.set_xdata([xpos, xpos + yBody_current[0]])
                self.line1_2.set_ydata([ypos, ypos + yBody_current[1]])
                self.line1_3.set_xdata([xpos, xpos + xBody_current[0]])
    ...
    def __call__(self, pipe):
        ...
        self.line1_1, = self.ax_xyplane.plot(xpos, ypos, "r") # vector in y-direction         
        self.line1_2, = self.ax_xyplane.plot(xpos, ypos, "g") # vector in y-direction
        self.line1_3, = self.ax_xyplane.plot(xpos, ypos, "b") # vector in x-direction  
        ...
        self.line2_3, = self.ax_xzplane.plot(xpos, ypos, "g") # vector in x-direction
